...
if (!has_data) {
  message(
    "SC4001E0-PSG.edf not found — chunks skipped. ",
    "See the 'Automatic AASM Sleep Staging' vignette for download instructions."
  )
}
```
...
(e.g. consolidated N2 or Wake). Lower values reflect genuine signal ambiguity
at stage transitions or in epochs with mixed features.
